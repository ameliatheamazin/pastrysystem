...
<div class="card border-warning mb-3" style="padding:5px">
    ...
    <div class="panel-heading">
        <h3 class="card-header">EDIT PRODUCT</h3><br>
    </div>
    <p><a href={{"/admin/product/".$product->id}} style="text-decoration:none; text-shadow:2px 2px 3px; font-size:17px; margin:10px">
            &larr; Back</a>
    </p>

    <div class="panel panel-default">
        <div class="card-body">
            <form method="POST" enctype="multipart/form-data" action={{'/admin/product/'.$product->id.'/edit'}}>
                @csrf
                 {{-- Per row --}}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="image_file" type="file" class="form-control @error('image_file')  @enderror" name="image_file">
                    </div>
                </div><br>
